...
export class SalesController {
  ...
  @Roles("ADMIN", "SALES", "PRODUCTION")
  @Permissions(Permission.SALES_READ)
  productByBarcode(@User() user: AuthUser, @Param("barcode") barcode: string, @Query("branchId") branchId?: string) {
  ...
  uploadShiftPhotos(@User() user: AuthUser, @UploadedFiles() files: Express.Multer.File[]) {
  ...
  @Roles("ADMIN")
  @Permissions(Permission.SALES_WRITE)
  deleteShiftPhoto(@User() user: AuthUser, @Param("shiftId") shiftId: string, @Body() dto: RemoveShiftPhotoDto) {
